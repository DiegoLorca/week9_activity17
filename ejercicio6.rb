...
# Se tiene un archivo llamado catalogo.txt que contiene los nombres de los productos que ofrece una tienda
# junto con los precios de las tallas L, M, S y XS.
